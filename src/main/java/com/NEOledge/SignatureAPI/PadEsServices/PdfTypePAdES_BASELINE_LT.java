...
public class PdfTypePAdES_BASELINE_LT {
    public PdfTypePAdES_BASELINE_LT() {

    }


    public DSSDocument signPdfTypePAdES_BASELINE_LT(Pkcs12SignatureToken signingToken, DSSDocument toSignDocument,Boolean visible,String imgSignature,String label) throws IOException {
