...
public class PdfTypePAdES_BASELINE_B {
    ...
    public DSSDocument signPdfTypePAdES_BASELINE_B(Pkcs12SignatureToken signingToken, DSSDocument toSignDocument,Boolean visible,String imgSignature,String label){
